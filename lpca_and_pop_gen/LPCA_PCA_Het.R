...
samples <- read_tsv("/home/564/km6006/Scripts/inversion_paper/samples.tsv",col_names="name")

### lostruct 
bcf.file <- "/g/data/ht96/McLay_UQ/inversion_paper/6_SNP_filtering/variant_only/HF_allpops_VO_0.8_final.bcf"
...
write.table(win.regions, "/g/data/ht96/McLay_UQ/inversion_paper/local_pca/1_win_regions.txt", sep="\t")
...
write.table(sig_mds_clusters, "/g/data/ht96/McLay_UQ/inversion_paper/local_pca/2_sig_mds_clusters.txt", sep="\t")
...
write.table(outlier_windows, "/g/data/ht96/McLay_UQ/inversion_paper/local_pca/3_outlier_windows.txt", sep="\t")
write.table(cluster_genotypes, "/g/data/ht96/McLay_UQ/inversion_paper/local_pca/4_cluster_genotypes.txt", sep="\t")
...
write.table(mds_counts, "/g/data/ht96/McLay_UQ/inversion_paper/local_pca/5_mds_counts.txt", sep="\t")
...
write.table(correlated_mds, "/g/data/ht96/McLay_UQ/inversion_paper/local_pca/6_correlated_mds.txt", sep="\t")
...
write.table(total_mds_coords, "/g/data/ht96/McLay_UQ/inversion_paper/local_pca/7_total_mds_coords.txt", sep="\t")
...
# heterozygosity
  ...
  heterozygosity <- inner_join(cluster_genotypes, heterozygosity)
  het_data <- rbind(het_data, heterozygosity)
}

write.table(mds_info, "/g/data/ht96/McLay_UQ/inversion_paper/local_pca/8_mds_info.txt", sep="\t")
write.table(het_data, "/g/data/ht96/McLay_UQ/inversion_paper/local_pca/9_genotypes_het.txt", sep="\t")