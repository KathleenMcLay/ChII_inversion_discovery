...
DATDIR="/g/data/ht96/McLay_UQ/inversion_paper/wgs_all"
QCDIR="/g/data/ht96/McLay_UQ/inversion_paper/1_QC"
ALDIR="/g/data/ht96/McLay_UQ/inversion_paper/2_align"
...
bwa mem -t 12 -M -R "@RG\tSM:${1}\tID:${1}\tLB:${1}\tPL:ILLUMINA\tPU:${1}" \
...
# check coverage
samtools coverage ${CLDIR}/${1}_PCRm_cln_srt.bam --output ${CLDIR}/${1}_coverage_hist.txt
